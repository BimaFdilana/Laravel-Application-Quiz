                                ...
                                @foreach ($quiz->questions as $qIndex => $question)
                                    <div class="question-item border p-3 mb-3 rounded">
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <select class="form-control question-type-select"
                                                ...
                                                <option value="multiple_choice"
                                                    @if ($question->type == 'multiple_choice') selected @endif>Pilihan Ganda</option>
                                        ...
                                        <div class="drag-drop-options"
                                            ...
                                            <label>Potongan Jawaban (Urutan sudah benar)</label>
                                            <div id="drag-answers-section-{{ $qIndex }}"
                                                class="drag-answers-section">
                                                @if ($question->type == 'drag_drop')
                                                    @foreach ($question->answers->sortBy('order') as $aIndex => $answer)
                                                        <div class="drag-answer-item d-flex align-items-center gap-2 mb-2">
                                                            <input type="hidden"
                                                                name="questions[{{ $qIndex }}][drag_answers][{{ $aIndex }}][id]"
                                                                value="{{ $answer->id }}">
                                                            <span class="fw-bold">{{ $loop->iteration }}.</span>
                                                            <input type="text" class="form-control"
                                                                name="questions[{{ $qIndex }}][drag_answers][{{ $aIndex }}][text]"
                                                                value="{{ $answer->answer_text }}">
                                                            <input type="file" class="form-control"
                                                                name="questions[{{ $qIndex }}][drag_answers][{{ $aIndex }}][image]">
                                                            @if ($answer->image_url)
                                                                <img src="{{ asset('storage/' . $answer->image_url) }}"
                                                                    class="img-thumbnail" width="50">
                                                            @endif
                                            ...
                                            <button type="button" class="btn btn-secondary btn-sm add-drag-answer"
                                                data-question="{{ $qIndex }}">Tambah Potongan Jawaban</button>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
